[CSAI415_Notebook.ipynb](https://github.com/user-attachments/files/29019289/CSAI415_Notebook.ipynb)
{
 "nbformat": 4,
 "nbformat_minor": 5,
 "metadata": {
   ...
   "outputs": [
    {
     "output_type": "stream",
     "name": "stdout",
     "text": "optuna not installed \u2014 using stub (AutoML study cell will be skipped)\nriver not installed \u2014 using stub (online learner still runs)\n\nSetup complete.\n"
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "output_type": "stream",
     "name": "stdout",
     "text": "Figures saved \u2014 automl_history.png  automl_comparison.png\n"
    }
   ],
   ...
   "outputs": [
    {
     "output_type": "stream",
     "name": "stdout",
     "text": "tests/test_metrics.py::TestNdcgAtK::test_perfect_ranking_returns_1 PASSED\ntests/test_metrics.py::TestNdcgAtK::test_zero_when_no_relevant_retrieved PASSED\ntests/test_metrics.py::TestNdcgAtK::test_lower_score_when_relevant_docs_ranked_later PASSED\ntests/test_metrics.py::TestNdcgAtK::test_empty_retrieved_returns_0 PASSED\ntests/test_metrics.py::TestNdcgAtK::test_accepts_list_for_relevant_ids PASSED\ntests/test_metrics.py::TestNdcgAtK::test_single_relevant_doc_at_rank_1 PASSED\ntests/test_metrics.py::TestNdcgAtK::test_single_relevant_doc_at_rank_2 PASSED\ntests/test_metrics.py::TestNdcgAtK::test_dcg_denominator_convention PASSED\ntests/test_metrics.py::TestRecallAtK::test_perfect_recall PASSED\ntests/test_metrics.py::TestRecallAtK::test_partial_recall PASSED\ntests/test_metrics.py::TestRecallAtK::test_zero_recall PASSED\ntests/test_metrics.py::TestRecallAtK::test_recall_is_position_blind PASSED\ntests/test_metrics.py::TestRecallAtK::test_cutoff_is_respected PASSED\ntests/test_metrics.py::TestReciprocalRank::test_first_relevant_at_rank_1 PASSED\ntests/test_metrics.py::TestReciprocalRank::test_first_relevant_at_rank_2 PASSED\ntests/test_metrics.py::TestReciprocalRank::test_first_relevant_at_rank_5 PASSED\ntests/test_metrics.py::TestReciprocalRank::test_no_relevant_in_top_k PASSED\ntests/test_metrics.py::TestMeanReciprocalRank::test_basic_mrr PASSED\ntests/test_metrics.py::TestMeanReciprocalRank::test_all_hits_at_rank_1 PASSED\ntests/test_metrics.py::TestMeanReciprocalRank::test_empty_query_list_returns_0 PASSED\ntests/test_metrics.py::TestEvaluateRanking::test_returns_all_three_keys PASSED\ntests/test_metrics.py::TestEvaluateRanking::test_perfect_retrieval_all_ones PASSED\ntests/test_metrics.py::TestEvaluateRanking::test_length_mismatch_raises PASSED\ntests/test_metrics.py::TestEvaluateRanking::test_empty_inputs_return_zeros PASSED\ntests/test_data_utils.py::test_corpus_shape PASSED\ntests/test_data_utils.py::test_relevant_chunk_ids_exist PASSED\ntests/test_data_utils.py::test_query_stream_size PASSED\ntests/test_evaluation.py::TestEvaluateRetrieverShape::test_returns_dict PASSED\ntests/test_evaluation.py::TestEvaluateRetrieverShape::test_contains_expected_keys_for_k5 PASSED\ntests/test_evaluation.py::TestEvaluateRetrieverShape::test_quality_metrics_in_unit_interval PASSED\ntests/test_evaluation.py::TestEvaluateRetrieverShape::test_latency_metrics_are_positive PASSED\ntests/test_evaluation.py::TestEvaluateRetrieverShape::test_p95_geq_mean PASSED\ntests/test_evaluation.py::TestEvaluateRetrieverPerQuery::test_returns_one_row_per_query PASSED\ntests/test_evaluation.py::TestEvaluateRetrieverPerQuery::test_row_contains_expected_keys PASSED\ntests/test_evaluation.py::TestEvaluateRetrieverPerQuery::test_per_query_ndcg_in_unit_interval PASSED\n\n35 passed in 4.21s\n"
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "output_type": "stream",
     "name": "stdout",
     "text": "FastAPI not running \u2014 showing API contract instead\n\napi.py endpoints:\n  @app.on_event(\"startup\")\n  @app.get(\"/health\")\n  @app.get(\"/search\")\n  @app.post(\"/feedback\")\n  @app.post(\"/ingest\")\n  @app.get(\"/stats\")\n\nretriever.py \u2014 search() signature:\n  def search(\n      self,\n      query: str,\n      top_k: int = 5,\n      bm25_weight: float = 0.4,\n      dense_weight: float = 0.6,\n      alpha: float | None = None,\n  ) -> list[dict[str, Any]]:\n"
    }
   ],
   "source": [
